...
//视图与标签过滤
    ...
    var vm = new Vue({
        el: '#app',
        data: {
            staticUrl: "http://static.iboom.tv/static/img/",/*http://192.168.1.122:6080/boom3/images/curcent_hadban_cs1.png*/
        ...
        methods: {
            ...
            getCourseList: function () {
                $.get("http://192.168.1.122:6080/boom3/json/recommendGroupId12.json", function (data, status) {
                    //console.log(data);
            ...
            getSlideList: function () {
                $.get("http://192.168.1.122:6080/boom3/json/recommendGroupId11.json", function (data, status) {
            ...
            getAllViews: function () {
                $.get("http://192.168.1.122:6080/boom3/json/labViewzhibo.json", function (data, status) {
