...
jQuery(document).ready(function () {
    ...
    var vm = new Vue({
        ...
        methods: {
            getStatue: function () {
                $.get("http://192.168.1.122:6080/boom3/json/statue", function (data, status) {
                    if (!data.data) {
            ...
            searchCourse: function (query) {
                ...
                jQuery.postJSON(newFilter, 'http://192.168.1.122:6080/boom3/json/courses', function (data) {
                    console.log(data);
                    if (data.data.length > 0) {
                        vm.courseList = data.data;
                        $(".close").click();
            ...
            getAllLabs: function (value) {
                ...
                $.ajax({
                    async: false,
                    url: "http://192.168.1.122:6080/boom3/json/labs",
                    success: function (data, status) {
